...
interface ITranchToken {
  ...
  function tknOperatorSend(uint256 _index, address _operator, address _from, address _to, uint256 _amount, bytes calldata _data, bytes calldata _operatorData) external;
}
