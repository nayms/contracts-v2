...
contract SimpleMarket is EventfulMarket, DSMath {
        ...
        returns (bool)
    {
        ...
        uint spend = SafeMath.div(SafeMath.mul(quantity, offer.buy_amt), offer.pay_amt);
        ...
        offers[id].pay_amt = SafeMath.sub(offer.pay_amt, quantity);
        offers[id].buy_amt = SafeMath.sub(offer.buy_amt, spend);
